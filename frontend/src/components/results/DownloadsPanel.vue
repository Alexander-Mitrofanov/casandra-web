...
<template>
  <section class="result-section downloads" aria-labelledby="downloads-heading"><div class="result-heading"><div><p class="eyebrow">Artifacts</p><h3 id="downloads-heading">Checksummed scientific outputs</h3></div><p>Authenticated downloads use the bearer token in a request header; neither the token nor sequence is placed in a URL.</p></div>
